...
// ICÔNES SVG
const ICONS = {
    BUS: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="5" width="16" height="11" rx="3"/><path d="M6 16v3"/><path d="M18 16v3"/><path d="M4 13h16"/><circle cx="8" cy="19" r="1"/><circle cx="16" cy="19" r="1"/></svg>`,
    busSmall: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="6" width="14" height="10" rx="2.5"/><path d="M6.5 14.5v2.5"/><path d="M17.5 14.5v2.5"/><path d="M5 12.5h14"/><circle cx="8.2" cy="17.8" r="0.9"/><circle cx="15.8" cy="17.8" r="0.9"/></svg>`,
    ...
    BICYCLE: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="6.5" cy="17.5" r="3.2"/><circle cx="17.5" cy="17.5" r="3.2"/><path d="M6.5 17.5L10 8h4l2 5h3"/><path d="M12 8l2 9.5"/><path d="M14.2 14.2 18 17.5"/></svg>`,
    WALK: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="2.2"/><path d="M9 21l2.4-6.4L8.5 11L11 9l3 2l1.6-3.8"/><path d="M13.5 14.5 17 21"/></svg>`,
